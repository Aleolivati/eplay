  ...
  const form = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      confirmDeliveryEmail: Yup.string()
        ...
        .required('O campo é obrigatório'),
      nameCardOwner: Yup.string().when((values, schema) =>
      ...
      {isSuccess && data ? (
        <Card title="Muito obrigado">
          <>
            ...
            <p className="marginTop justify-text">
              ...
              <div className="marginTop">
                {payWithCard ? (
                    ...
                    <S.Row>
                      <S.InputGroup>
                        ...
                        <input
                          ...
                          type="text"
                          name="nameCardOwner"
                          value={form.values.nameCardOwner}
                          onChange={form.handleChange}
                          onBlur={form.handleBlur}
                          className={
                            checkInputHasError('nameCardOwner') ? 'error' : ''
                          }
                        />
                      </S.InputGroup>
                      <S.InputGroup>
                  ...
                  <p className="justify-text">
                    ...
                    adquirido ocorrerá somente após a do pagamento do boleto.
                  </p>
                )}
              </div>
            </>
