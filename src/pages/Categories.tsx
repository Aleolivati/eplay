...
const Categories = () => (
  <>
    <ProductsList background="gray" title="RPG" games={promotions} />
    <ProductsList background="black" title="Ação" games={commingSoon} />
    <ProductsList background="gray" title="Aventura" games={promotions} />
    <ProductsList background="black" title="FPS" games={commingSoon} />
  </>
)
